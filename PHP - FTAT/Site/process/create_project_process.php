...
if (isset($_POST['project_name'], $_POST['project_description'], $_POST['project_date_fin'], $_POST['scrum_master'])) {
    ...
    if (isset($bdd)) {
        try {
            ...
            $sql_addProject = "INSERT INTO AgileTools.projets(NomP, DescriptionP, DateDebutP, DateFinP) VALUES (:NomP, :DescriptionP, CURDATE(), :DateFinP)";
            ...
            $sql_addRUP = "INSERT INTO AgileTools.rolesutilisateurprojet(IdU, IdP, IdR) VALUES (:IdU, :IdP, :IdR)";
